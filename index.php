					...
					<div class="col-lg-7">
                        <div class="row">
							<div class="col-8 match-view-tite">
								<h3 class="title-bg">Tournaments</h3>
							</div>
							<div class="col-4 text-right match-view-more">
								<a class="view-more" href="active.php">View More <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
							</div>
						</div>
                        <div class="row">
                            <div class="col-sm-12">
					        	...
					        	<div class="latest-news-slider">
					        		<div>
										<div class="news-normal-block">
					                    	...
					                    	<h4 class="news-title"><a href="blog-single.html">TFC Club Score Seven in CL Rout Match</a></h4>
					                    	<div class="news-desc">
					                    		<p>
